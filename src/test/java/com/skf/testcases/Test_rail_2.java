...
public class Test_rail_2 extends Pages{
  ...
  @Test
  public void verifyRail2() throws Exception {

	  fisco = new FileInputStream(path + "\\src\\test\\resources\\properties\\Config.properties");
		config.load(fisco);
		LoginPage loginPage = new LoginPage();
		loginPage.loginApp(config.getProperty("Test_rail_2_user"),
		config.getProperty("Test_rail_2_pass"));
