...
public class Test_wind_126 extends Page {
	...
	@Test
	  public void verifyReportFeedbackEditable() throws Exception {
			 ...
			 loginPage.loginApp(config.getProperty("test_wind_126_login"), config.getProperty("test_wind_126_pass"));
	...
	@Test
	  public void verifyAnalyticsInsight() throws Exception
	  {
		  fisco = new FileInputStream(path + "\\src\\test\\resources\\properties\\Config.properties");
			config.load(fisco);
			LoginPage loginPage = new LoginPage();
