...
public class Test_wind_49 extends Page{
	...
	@Test
	  public void verifyTurbineOverview() throws Exception {
		  ...
		  fisco = new FileInputStream(path + "\\src\\test\\resources\\properties\\Config.properties");
			 ...
			 loginPage.loginApp(config.getProperty("test_wind_49_login"), config.getProperty("test_wind_49_pass"));
			 ...
			 turbinePage.turbinedatafield().sendKeys("ART1_U006");
