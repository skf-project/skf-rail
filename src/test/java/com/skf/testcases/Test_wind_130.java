...
public class Test_wind_130 extends Page{
	...
	@Test
	  public void verifyTurbineOverview() throws Exception {
			 ...
			 loginPage.loginApp(config.getProperty("test_wind_130_login"), config.getProperty("test_wind_130_pass"));
	  ...
	  public void verifyAnalytics() throws Exception
	  {
			...
			config.load(fisco);
			LoginPage loginPage = new LoginPage();
			loginPage.loginApp(config.getProperty("test_wind_26_login"), config.getProperty("test_wind_26_pass"));
			Thread.sleep(15000);
