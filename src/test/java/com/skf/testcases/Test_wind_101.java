...
import com.skf.pages.TurbinePage;
    ...
    public class Test_wind_101 extends Page {
	...
	public static FileInputStream fisco;
	  ...
	  public void verifyTurbineOverview() throws Exception {
			 ...
			 loginPage.loginApp(config.getProperty("test_wind_101_login"), config.getProperty("test_wind_101_pass"));
			 ...
			 turbinePage.turbinedatafield().sendKeys("CGD_U003");
